...
import { TCityResponse, TCityForm, TUpdateCityParams, TCitiesParams } from './entities';
import axios from '@/utils/axios';

export const fetchCities = async (params: TCitiesParams): Promise<TPaginateResponse<TCityResponse>> => {
