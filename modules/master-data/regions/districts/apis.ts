...
import { TDistrictResponse, TDistrictForm, TUpdateDistrictParams, TDistrictsParams } from './entities';
import axios from '@/utils/axios';

export const fetchDistricts = async (params: TDistrictsParams): Promise<TPaginateResponse<TDistrictResponse>> => {
